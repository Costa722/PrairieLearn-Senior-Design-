...
def generate(data):
    ...
    data['params']['leftCircleButtonZero_bit'] = leftCircleButtonZero_bit
    data['params']['leftCircleButtonOne_bit'] = leftCircleButtonOne_bit
    data['params']['rightCircleButtonTwo_bit'] = rightCircleButtonTwo_bit
    data['params']['rightCircleButtonThree_bit'] = rightCircleButtonThree_bit
    data['params']['leftCircleLEDZero_bit'] = leftCircleLEDZero_bit
    data['params']['leftCircleLEDOne_bit'] = leftCircleLEDOne_bit
    data['params']['rightCircleLEDTwo_bit'] = rightCircleLEDTwo_bit
    data['params']['rightCircleLEDThree_bit'] = rightCircleLEDThree_bit
